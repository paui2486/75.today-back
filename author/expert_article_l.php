...
$query_news = "SELECT * FROM expert_article WHERE expert = ".$_SESSION['EXPERT_ID']." and n_id > 130 Order by n_status";
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr  bgcolor="#FFFFFF">
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="1" id="article_list" class="display">
                ...
                <tr bgcolor="#DDDDDD" >
                  ...
                  <th align="center" background="images/transp.gif" bgcolor="#999999" class="contnet_w">顯示狀態</th>
  ...
  <tr bgcolor="#DDDDDD" >
    ...
    <td align="center" bgcolor="#FFFFFF" class="text_cap"><?php echo $row_news['n_title']; ?></td>
     <td align="center" bgcolor="#FFFFFF" class="text_cap"><?php echo mb_substr(strip_tags($row_news['n_cont']),0,50,"utf-8"); ?></td>
    <td align="center" bgcolor="#FFFFFF" class="text_cap">
        <?php 
            if($row_news['n_status']=='Y'){ echo "顯示"; } else {echo "（草稿）"; };
        ?>
    </td>
    ...
    <?php } ?>
      <?php if($row_news['n_status']=='Y') {?>
      <input name="button2" type="submit" class="sform_b" id="button2" onClick="dele('<?php echo $row_news['n_id']; ?>')" value="設為草稿">
      <?php } ?>
      </td>
  </tr>
