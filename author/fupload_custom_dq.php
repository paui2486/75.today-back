...
<form ACTION="fupaction_custom_dq.php" METHOD="POST" name="form1" enctype="multipart/form-data">
  <table width="100%" height="100%" border="0" cellpadding="4" cellspacing="0">
    ...
    <tr> 
      <td height="20" align="center"> 
        ...
        <input name="pathUrl" type="hidden" id="pathUrl" value="<?php echo $_GET['pathUrl']; ?>">
        
        <input name="useForm" type="text" id="useForm" value="<?php echo $_GET['useForm']; ?>"><br>
        <input name="upUrl" type="text" id="upUrl" value="<?php echo $_GET['upUrl']; ?>"> <br>
        <input name="prevImg" type="text" id="prevImg" value="<?php echo $_GET['prevImg']; ?>"><br>
        <input name="reItem" type="text" id="reItem" value="<?php echo $_GET['reItem']; ?>"><br>
        <input name="pathUrl" type="text" id="pathUrl" value="<?php echo $_GET['pathUrl']; ?>"><br>
      </td>
    </tr>
    <tr> 
      <td height="20" align="center"> 
