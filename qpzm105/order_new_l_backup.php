...
if (isset($_GET['ord_status'])) {
  if ($_GET['ord_status'] == 0){$newsql = "SELECT * FROM order_list LEFT JOIN Product ON order_list.ord_p_id = Product.p_id WHERE ord_status >= '3' AND ord_status <= '7' ORDER BY ord_status ASC, ord_id DESC";} 
  else { $status = $_GET['ord_status']; $newsql = "SELECT * FROM order_list LEFT JOIN Product ON order_list.ord_p_id = Product.p_id WHERE ord_status = '".$status."' AND ord_status >= '3' AND ord_status <= '7' ORDER BY ord_status ASC, ord_id DESC";}
  }
else{
  $newsql = "SELECT * FROM order_list LEFT JOIN Product ON order_list.ord_p_id = Product.p_id WHERE ord_status >= '3' AND ord_status <= '7' ORDER BY ord_status ASC, ord_id DESC";	
}
