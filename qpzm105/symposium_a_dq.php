...
if (isset($_POST["title"])) {
  ...
  $insertSQL = sprintf("INSERT INTO symposium (title, start_date, address, area, fee, description, active, creator, pic1, pic2, pic3, pic4, pic5, create_time, contain_html,contacter, contact_email,contact_phone)
        ...
        $("input[name='zipcode']").hide();
                  ...
                  <tr bgcolor="#DDDDDD" class="t9">
                    ...
                    <td bgcolor="#FFFFFF">&nbsp;<img src="icon_prev.gif" alt="圖片預覽" name="showImg1" id="showImg1" onClick='javascript:alert("圖片預覽");'>
                      <input name="Submit_pic1" type="button" class="sform_g" onClick="window.open('fupload_custom_dq.php?useForm=form1&amp;prevImg=showImg1&amp;upUrl=../web&amp;ImgS=&amp;ImgW=&amp;ImgH=&amp;reItem=pic1&amp;pathUrl=http://www.iwine.com.tw','fileUpload','width=500,height=300')" value="準備上傳">
