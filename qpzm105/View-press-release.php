...
$query_news = "SELECT * FROM Press_release where 1 ORDER BY creat_time DESC";
...
function dele(ids){
	if(window.confirm('確定要刪除?')){
		window.location='Press_release_d.php?p_id='+ids;//呼叫刪除的文章的檔案 傳過去的變數是p_id
	}
}
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" bgcolor="666666"><table width="100%" height="605" border="0" align="center" cellpadding="0" cellspacing="8">
      ...
      <tr>
        <td height="40" align="center" valign="middle"><span class="capw"><font color="#FFFFFF">◎ 檢視新聞稿內容 ◎</font></span></td>
        </tr>
      <tr>
        <td height="2" bgcolor="#FFFFFF"></td>
        </tr>
  ...
  <tr bgcolor="#DDDDDD" >
    ...
    <td align="center" bgcolor="#FFFFFF" class="contnet_w"><input name="button" type="button" class="sform_g" id="button" onClick="MM_goToURL('self','Press_release_s.php?id=<?php echo $row_news['id']; ?>');return document.MM_returnValue" value="檢視或修改">
