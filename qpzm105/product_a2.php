...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO Product_shop (p_code, p_name, p_subtitle, p_price1, p_price2, p_price3, p_spec, p_description, p_memo, p_storage, p_update_time, p_online, p_file1, p_file2, p_file3, p_file4, p_file5, p_class, p_start_time, p_end_time, p_type, p_order, p_gift, p_index) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['p_order'], "int"),
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" bgcolor="666666"><table width="100%" height="605" border="0" align="center" cellpadding="0" cellspacing="8">
      ...
      <tr>
        <td height="40" align="center" valign="middle"><span class="capw"><font color="#FFFFFF">◎ 複製商品內容 ◎</font></span></td>
        </tr>
      <tr>
        <td height="2" bgcolor="#FFFFFF"></td>
        </tr>
...
?>
                  ...
                  <tr bgcolor="#DDDDDD" class="t9">
                    ...
                    <td bgcolor="#FFFFFF" class="text_cap"><input name="p_price2" type="text" class="sform" id="p_price2" value="<?php echo $row_Product['p_price2']; ?>" size="20">                      
                      元（必填，一般售價）</td>
                    </tr>
                  <tr bgcolor="#DDDDDD" class="t9">
                  ...
                  <tr bgcolor="#DDDDDD" class="t9">
                    <td align="right" background="images/transp.gif" bgcolor="#999999" class="contnet_w">規格：</td>
                    <td bgcolor="#FFFFFF" class="text_cap">
...
?>
                  ...
                  <tr bgcolor="#F3F3F1" class="t9">
                    <td colspan="2" align="right"><input name="status2" type="submit" class="sform_g" onClick="tmt_confirm('確定要複製本商品?');return document.MM_returnValue" value="確定複製">
                      <input name="Reset" type="reset" class="sform_b" id="Reset2" value="重設">
                      <input name="button" type="button" class="sform_r" id="button" onClick="history.back()" value="放棄複製"></td>
                    </tr>
                  </table>
                </div>
