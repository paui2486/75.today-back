...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE expert SET account=%s,title=%s, name=%s, active=%s, icon=%s, introduction=%s, e_order=%s, view_count=%s, agree_ad=%s,description=%s,keyword=%s  WHERE id=%s",
