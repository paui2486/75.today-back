...
$updateSQL = sprintf("UPDATE alliance_contact SET c_status='1', c_reply=%s, c_reply_title=%s, c_reply_datetime=%s, c_reply_who=%s WHERE c_id=%s",
...
<p><strong>☆此信件為系統信箱發出，請勿直接回覆本郵件；如有其他疑問，請至<a href=\"http://ww1.iwine.com.tw/service.php\">【iWine】團體網策略聯盟「聯絡我們」</a>提出☆</strong></p>";
