...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO bar (company_name, owner, contact, address, telphone, fax, email, vat_num, active, regist_date, last_login, mod_time, category, open_time, cons_pattems, products,  pic1, pic2, pic3, pic4, pic5, corkage_fee, glass_type) 
                       ...
                       GetSQLValueString($_today, "date"),
                       GetSQLValueString($_today, "date"),
                       GetSQLValueString($_POST['cagegory'], "text"),
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" bgcolor="666666"><table width="100%" height="605" border="0" align="center" cellpadding="0" cellspacing="8">
      ...
      <tr>
        <td height="40" align="center" valign="middle"><span class="capw"><font color="#FFFFFF">◎ 新增酒館內容 ◎</font></span></td>
        </tr>
      <tr>
        <td height="2" bgcolor="#FFFFFF"></td>
        </tr>
              ...
              <div align="center">
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="table">
                  ...
                  <tr bgcolor="#DDDDDD" class="t9">
                    ...
                    <td bgcolor="#FFFFFF" class="description"><input name="corkage_fee" type="number" class="sform" id="corkage_fee" min="0" value="" size="30">0表示無開瓶費</td>
                  </tr>
                  <tr bgcolor="#DDDDDD" class="t9">
                    <td align="right" background="images/transp.gif" bgcolor="#999999" class="contnet_w">bar 負責人:</td>
                  ...
                  <tr bgcolor="#DDDDDD" class="t9">
                    <td align="right" background="images/transp.gif" bgcolor="#999999" class="contnet_w">營業時間:</td>
                    <td bgcolor="#FFFFFF"><input name="open_time" type="text" class="sform" id="open_time" size="100"></td>
                  </tr>
                  <tr bgcolor="#DDDDDD" class="t9">
                    <td align="right" background="images/transp.gif" bgcolor="#999999" class="contnet_w">消費方式:</td>
                    <td bgcolor="#FFFFFF"><input name="cons_pattems" type="text" class="sform" id="cons_pattems" size="100"></td>
                  </tr>
                  <tr bgcolor="#DDDDDD" class="t9">
                    <td align="right" background="images/transp.gif" bgcolor="#999999" class="contnet_w">主打商品:</td>
                    <td bgcolor="#FFFFFF"><input name="cons_pattems" type="text" class="sform" id="cons_pattems" size="100"></td>
                  </tr>
                  <?php for ($i=1 ; $i<=5; $i++) {?>
                    <?php $c_pic = 'pic'.$i; ?>
                        <tr bgcolor="#DDDDDD" class="t9">
                            <td align="right" background="images/transp.gif" bgcolor="#999999" class="contnet_w">圖檔<?php echo $i; ?>:</td>
                            <td bgcolor="#FFFFFF">&nbsp;<img src="icon_prev.gif" alt="圖片預覽" name="showImg<?php echo $i; ?>" id="showImg<?php echo $i; ?>" onClick='javascript:alert("圖片預覽");'>
                              <input name="Submit_<?php echo $c_pic; ?>" type="button" class="sform_g" onClick="window.open('fupload_custom.php?useForm=form1&amp;prevImg=showImg<?php echo $i; ?>&amp;upUrl=../../web/webimages/bar&amp;ImgS=&amp;ImgW=&amp;ImgH=&amp;reItem=<?php echo $c_pic; ?>&amp;pathUrl=http://www.iwine.com.tw/webimages/bar','fileUpload','width=500,height=300')" value="準備上傳">
                              <input name="<?php echo $c_pic; ?>" type="hidden" id="<?php echo $c_pic; ?>" size="4"></td>
                          </tr>
                  <?php } ?>
