...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form5")) {
  $updateSQL = sprintf("UPDATE order_list SET ord_ship_name=%s, ord_ship_mobile=%s, ord_ship_zip=%s, ord_ship_county=%s, ord_ship_city=%s, ord_ship_address=%s, ord_ship_email=%s, ord_status=%s, ord_memo2=%s, ord_ship_date=%s, adm_account=%s, adm_datetime=%s WHERE ord_id=%s",
                       GetSQLValueString($_POST['ord_ship_name'], "text"),
                       GetSQLValueString($_POST['ord_ship_mobile'], "text"),
                       GetSQLValueString($_POST['ord_ship_zip'], "text"),
                       GetSQLValueString($_POST['ord_ship_county'], "text"),
                       GetSQLValueString($_POST['ord_ship_city'], "text"),
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td bgcolor="#494949"><table width="100%" border="0" cellpadding="4" cellspacing="1" class="table">
                  ...
                  <tr>
                    ...
                    <td valign="middle" bgcolor="#FFFFFF" class="sform"><div align="left">
                      <select name="ord_status" class="sform" id="ord_status">
                        ...
                        <option value="11" <?php if (!(strcmp(11, $row_Recordset1['ord_status']))) {echo "selected=\"selected\"";} ?>>貨到付款未出貨</option>
                        <option value="21" <?php if (!(strcmp(21, $row_Recordset1['ord_status']))) {echo "selected=\"selected\"";} ?>>查無帳款，請與我們聯繫</option>
                        <option value="22" <?php if (!(strcmp(22, $row_Recordset1['ord_status']))) {echo "selected=\"selected\"";} ?>>金額不符，請與我們聯繫</option>
                  ...
                  <tr>
                    ...
                    <td valign="middle" bgcolor="#FFFFFF" class="sform"><div align="left">
                      <input name="ord_ship_name" type="text" class="sform" id="ord_ship_name" value="<?php echo $row_Recordset1['ord_ship_name']; ?>">
                    </div></td>
                    <td valign="middle" background="images/transp.gif" bgcolor="#999999" class="contnet_w"><div align="right">收貨人手機:</div></td>
                    <td valign="middle" bgcolor="#FFFFFF" class="sform"><div align="left">
                      <input name="ord_ship_mobile" type="text" class="sform" id="ord_ship_mobile" value="<?php echo $row_Recordset1['ord_ship_mobile']; ?>">
                    </div></td>
                  </tr>
                  <tr>
                    <td background="images/transp.gif" bgcolor="#999999" class="contnet_w"><div align="right">收貨人地址:</div></td>
                    <td colspan="3" valign="middle" bgcolor="#FFFFFF" class="sform"><div align="left">
                      <input name="ord_ship_zip" type="text" class="sform" id="ord_ship_zip" value="<?php echo $row_Recordset1['ord_ship_zip']; ?>" size="6">
                      <input name="ord_ship_county" type="text" class="sform" id="ord_ship_county" value="<?php echo $row_Recordset1['ord_ship_county']; ?>" size="10">
                      <input name="ord_ship_city" type="text" class="sform" id="ord_ship_city" value="<?php echo $row_Recordset1['ord_ship_city']; ?>" size="10">
                      <input name="ord_ship_address" type="text" class="sform" id="ord_ship_address" value="<?php echo $row_Recordset1['ord_ship_address']; ?>" size="50">
                    </div></td>
                  </tr>
                  <tr>
                    <td background="images/transp.gif" bgcolor="#999999" class="contnet_w"><div align="right">收貨人E-mail:</div></td>
                    <td colspan="3" valign="middle" bgcolor="#FFFFFF" class="sform"><div align="left">
                      <input name="ord_ship_email" type="text" class="sform" id="ord_ship_email" value="<?php echo $row_Recordset1['ord_ship_email']; ?>" size="50">
                    </div></td>
                  </tr>
                  <tr>
                    ...
                    <td valign="middle" bgcolor="#FFFFFF" class="sform"><div align="left"><?php 
						...
						?></div></td>
                    <td valign="middle" background="images/transp.gif" bgcolor="#999999" class="contnet_w"><div align="right">虛擬帳號（國泰世華，第5～8碼為繳款期限日）:</div></td>
                  ...
                  <tr>
                    <td background="images/transp.gif" bgcolor="#999999" class="contnet_w"><div align="right">各團體商品訂購數量:</div></td>
                    <td valign="middle" bgcolor="#FFFFFF" class="sform"><div align="left">主要商品：<br>
                  ...
                  <tr>
                    <td background="images/transp.gif" bgcolor="#999999" class="contnet_w"><div align="right">商品搭配數量:</div></td>
                    <td valign="middle" bgcolor="#FFFFFF" class="sform"><div align="left"> 
  ...
  <?php } ?>
                    ...
                    <td valign="middle" background="images/transp.gif" bgcolor="#999999" class="contnet_w">&nbsp;</td>
                    <td valign="middle" bgcolor="#FFFFFF" class="sform">&nbsp;</td>
                  </tr>
                  <?php } ?>
                  <tr>
                    ...
                    <td background="images/transp.gif" bgcolor="#999999" class="contnet_w"><div align="right">手續費:</div></td>
                    <td valign="middle" bgcolor="#FFFFFF" class="sform"><div align="left"><?php echo $row_Recordset1['ord_hand_price']; ?></div></td>
                    </tr>
                  <tr>
                    <td background="images/transp.gif" bgcolor="#999999" class="contnet_w"><div align="right">付款總金額:</div></td>
                    <td colspan="3" valign="middle" bgcolor="#FFFFFF" class="sform"><div align="left"><?php echo $row_Recordset1['ord_total_price']; ?></div></td>
                    </tr>
                  <tr>
                    ...
                    <tr>
                    <td background="images/transp.gif" bgcolor="#999999" class="contnet_w"><div align="right">公司抬頭:</div></td>
                    <td colspan="3" valign="middle" bgcolor="#FFFFFF" class="sform"><?php echo $row_Recordset1['ord_ship_fa_name']; ?></td>
                  </tr>
                  <tr>
                    <td background="images/transp.gif" bgcolor="#999999" class="contnet_w"><div align="right">公司統編:</div></td>
                    <td colspan="3" valign="middle" bgcolor="#FFFFFF" class="sform"><?php echo $row_Recordset1['ord_ship_fa_id']; ?></td>
                  </tr>
<tr>
...
// EndWebWidget jQuery_UI_Calendar: sdate1
                  ...
                  <tr>
                    <td background="images/transp.gif" bgcolor="#999999" class="contnet_w"><div align="right">物流編號:</div></td>
                    <td colspan="3" valign="middle" bgcolor="#FFFFFF" class="text_cap2"><?php echo $row_Recordset1['ord_ship_code']; ?></td>
                  </tr>
                  <tr>
                    <td background="images/transp.gif" bgcolor="#999999" class="contnet_w"><div align="right">發票號碼:</div></td>
                    <td colspan="3" valign="middle" bgcolor="#FFFFFF" class="text_cap2"><?php echo $row_Recordset1['ord_ship_fa_code']; ?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="4" align="center" background="images/transp.gif" bgcolor="#999999" class="contnet_w"><input name="button3" type="submit" class="sform_b" id="button3" onClick="tmt_confirm('確定要更新訂單?');return document.MM_returnValue" value="更新訂單">                      <input name="button" type="button" class="sform_r" id="button" onClick="window.close()" value="關閉本視窗"></td>
                    </tr>
                </table></td>
              </tr>
            </table>
