...
function dele(ids){
	if(window.confirm('確定要刪除?')){
		window.location='alliance_contact_d.php?s_id='+ids;
	}
}
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" bgcolor="666666"><table width="100%" height="605" border="0" align="center" cellpadding="0" cellspacing="8">
      ...
      <tr>
        <td height="40" align="center" valign="middle"><span class="capw"><font color="#FFFFFF">◎ 檢視最新盟友聯絡事項 ◎</font></span></td>
        </tr>
      <tr>
        <td height="2" bgcolor="#FFFFFF"></td>
        </tr>
                  ...
                  <?php do { ?>
                    <?php if ($totalRows_flash > 0) { // Show if recordset not empty ?>
                      <tr class="text_cap2" >
                        ...
                        <td align="center" bgcolor="#FFFFFF"><input name="button" type="button" class="sform_g" id="button" onClick="window.open('alliance_contact_s.php?c_id=<?php echo $row_flash['c_id']; ?>&page=0');return document.MM_returnValue" value="檢視完整內容"></td>
                        </tr>
