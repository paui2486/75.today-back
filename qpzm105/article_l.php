...
$query_news = "SELECT * FROM article LEFT JOIN article_class ON article.n_class = article_class.pc_id ORDER BY n_id DESC, n_order ASC";
...
function dele(ids){
	if(window.confirm('確定要刪除?')){
		window.location='article_d.php?p_id='+ids;
	}
}
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" bgcolor="666666"><table width="100%" height="605" border="0" align="center" cellpadding="0" cellspacing="8">
      ...
      <tr>
        <td height="40" align="center" valign="middle"><span class="capw"><font color="#FFFFFF">◎ 檢視文章內容 ◎</font></span></td>
        </tr>
      <tr>
        <td height="2" bgcolor="#FFFFFF"></td>
        </tr>
