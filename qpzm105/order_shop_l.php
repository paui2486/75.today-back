...
$newSQL = "SELECT * FROM order_list_shop LEFT JOIN member ON order_list_shop.ord_acc_id = member.m_id WHERE".$SQL_2.$SQL_21.$SQL_30.$SQL_31.$SQL_32.$SQL_33.$SQL_4.$SQL_5.$SQL_6.$SQL_7." ORDER BY ord_date DESC, ord_code DESC";
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" bgcolor="666666"><table width="100%" height="605" border="0" align="center" cellpadding="0" cellspacing="8">
      ...
      <tr>
        <td height="40" align="center" valign="middle"><span class="capw"><font color="#FFFFFF">◎ 檢視商城訂單 ◎</font></span></td>
        </tr>
      <tr>
        <td height="2" bgcolor="#FFFFFF"></td>
        </tr>
      <tr>
        ...
        <table width="90%" border="0" cellspacing="0" cellpadding="3">
          <tr>
            <td bgcolor="#494949">
            <form name="form1" method="post" action="order_shop_l.php">
            ...
            <td><table width="100%" border="1" cellpadding="5" cellspacing="0" id="product_list" class="display">
              ...
              <tbody>
                ...
                <tr >
                  ...
                  <td align="center" bgcolor="#FFFFFF" class="text_cap2"><a href="javascript:window.open('order_shop_s.php?ord_id=<?php echo $row_order['ord_id']; ?>&page=0');return document.MM_returnValue"><?php echo $row_order['ord_code']; ?></a></td>
              ...
              <tfoot>
                <tr bgcolor="#F3F3F1" >
                  <th colspan="13" align="center" class="text_w">訂單總金額：<?php echo $_total_order_price; ?></th>
                </tr>
                <tr bgcolor="#F3F3F1" >
