...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE Press_release SET title=%s, creat_time=%s, Article=%s, pic_1=%s WHERE id=%s",
                       ...
                       GetSQLValueString($_POST['pic_1'], "text"),//圖
...
$query_news = sprintf("SELECT * FROM Press_release WHERE id = %s", GetSQLValueString($colname_news, "int"));
$news = mysql_query($query_news, $iwine) or die(mysql_error());
$row_news = mysql_fetch_assoc($news);
$totalRows_news = mysql_num_rows($news);

mysql_select_db($database_iwine, $iwine);// 內文
$query_article_class = "SELECT * FROM Press_release ORDER BY creat_time DESC";
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" bgcolor="666666"><table width="100%" height="605" border="0" align="center" cellpadding="0" cellspacing="8">
      ...
      <tr>
        <td height="40" align="center" valign="middle"><span class="capw"><font color="#FFFFFF">◎ 修改新聞稿內容 ◎</font></span></td>
        </tr>
      <tr>
        <td height="2" bgcolor="#FFFFFF"></td>
        </tr>
              ...
              <div align="center">
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="table">
                  ...
                  <tr bgcolor="#DDDDDD" class="t9">
                    ...
                    <td bgcolor="#FFFFFF"><input name="title" type="text" class="sform" id="n_title" value="<?php echo $row_news['title']; ?>" size="50"></td>
                  </tr>

                  <tr bgcolor="#DDDDDD" class="t9">
                    <td width="15%" align="right" background="images/transp.gif" bgcolor="#999999" class="contnet_w">內容:</td>
                    <td bgcolor="#FFFFFF"><textarea name="Article" id="n_cont" cols="60" rows="10" class="ckeditor"><?php echo $row_news['Article']; ?></textarea>
...
filebrowserFlashUploadUrl : 'ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash'
                  ...
                  <tr bgcolor="#DDDDDD" class="t9">
                    ...
                    <td bgcolor="#FFFFFF">&nbsp;<img src="<?php if($row_news['pic_1']<>""){ echo "http://www.iwine.com.tw/webimages/symposium/".$row_news['pic_1'];}else{ echo "icon_prev.gif";} ?>" alt="圖片預覽" name="showImg" id="showImg" onClick='javascript:alert("圖片預覽");'><br>
                      ...
                      <input name="pic_1" type="text" class="sform" id="rePic" value="<?php echo $row_news['pic_1']; ?>" size="20">
                      (欄位留白可刪除圖片)</td>
                  </tr>
