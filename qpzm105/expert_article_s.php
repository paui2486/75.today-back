...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE expert_article SET n_title=%s, expert=%s, n_date=%s, n_cont=%s, n_fig1=%s, n_tag=%s, n_order=%s, view_counter=%s, n_status=%s, n_hot=%s, n_description=%s, n_keyword=%s,n_socialnum=%s WHERE n_id=%s",
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="table">
                  ...
                  <tr bgcolor="#DDDDDD" class="t9">
                    ...
                    <td bgcolor="#FFFFFF"><select name="expert" class="sform" id="expert">
                      <option value="0" <?php if (!(strcmp(0, $row_news['expert']))) {echo "selected=\"selected\"";} ?>>請選擇達人</option>
                      <?php
do {  
?>
                      <option value="<?php echo $row_expert['id']?>"<?php if (!(strcmp($row_expert['id'], $row_news['expert']))) {echo "selected=\"selected\"";} ?>><?php echo $row_expert['name']?></option>
                      <?php
...
<input name="n_id" type="hidden" id="n_id" value="<?php echo $row_news['n_id']; ?>"></td>
                  ...
                  <tr bgcolor="#DDDDDD" class="t9">
                    ...
                    <td width="386" bgcolor="#FFFFFF"><input name="view_counter" type="number" class="sform" min="0" id="view_counter" value="<?php echo $row_news['view_counter']; ?>" size="80"></td>
                  </tr>
