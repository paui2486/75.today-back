...
$query_flash = "SELECT * FROM index_fig ORDER BY b_order ASC";
...
function dele(ids){
	if(window.confirm('確定要刪除?')){
		window.location='index_fig_d.php?b_id='+ids;
	}
}
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" bgcolor="666666"><table width="100%" height="605" border="0" align="center" cellpadding="0" cellspacing="8">
      ...
      <tr>
        <td height="40" align="center" valign="middle"><span class="capw"><font color="#FFFFFF">◎ 檢視首頁大圖輪播 ◎</font></span></td>
        </tr>
      <tr>
        <td height="2" bgcolor="#FFFFFF"></td>
        </tr>
              ...
              <div align="center">
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="table">
                  <tr bgcolor="#DDDDDD" >
                    ...
                    <td align="center" background="images/transp.gif" bgcolor="#999999" class="contnet_w">標題</td>
  ...
  <tr >
    <td align="center" bgcolor="#FFFFFF"><?php /*start inputVar script*/ if (isset($row_flash['b_file'])){ ?>
      <img src="../webimages/index/<?php echo $row_flash['b_file']; ?>" width="240">
      <?php } /*end inputVar script*/ ?></td>
    <td align="center" bgcolor="#FFFFFF"><?php echo $row_flash['b_name']; ?></td>
    ...
    <td align="center" bgcolor="#FFFFFF"><span class="text_cap"><?php echo $row_flash['b_order']; ?></span></td>
    <td align="center" bgcolor="#FFFFFF"><input name="button" type="button" class="sform_g" id="button" onClick="MM_goToURL('self','index_fig_s.php?b_id=<?php echo $row_flash['b_id']; ?>');return document.MM_returnValue" value="檢視或修改">
