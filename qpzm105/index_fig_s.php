...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE index_fig SET b_name=%s, b_subname=%s, b_file=%s, b_url=%s, b_status=%s, b_order=%s WHERE b_id=%s",
                       GetSQLValueString($_POST['b_name'], "text"),
                       GetSQLValueString($_POST['b_subname'], "text"),
...
mysql_select_db($database_iwine, $iwine);
$query_ad = sprintf("SELECT * FROM index_fig WHERE b_id = %s", GetSQLValueString($colname_ad, "int"));
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" bgcolor="666666"><table width="100%" height="605" border="0" align="center" cellpadding="0" cellspacing="8">
      ...
      <tr>
        <td height="40" align="center" valign="middle"><span class="capw"><font color="#FFFFFF">◎ 檢視或修改首頁大圖輪播 ◎</font></span></td>
        </tr>
      <tr>
        <td height="2" bgcolor="#FFFFFF"></td>
        </tr>
              ...
              <div align="center">
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="table">
                  <tr bgcolor="#DDDDDD" class="t9">
                    <td width="20%" align="right" background="images/transp.gif" bgcolor="#999999" class="contnet_w">圖檔(1000x521):</td>
                    <td bgcolor="#FFFFFF">&nbsp;<img src="<?php if($row_ad['b_file']<>""){ echo "../webimages/index/".$row_ad['b_file'];}else{ echo "icon_prev.gif";} ?>" alt="圖片預覽" name="showImg" id="showImg" onClick='javascript:alert("圖片預覽");'><br>
                      <input name="Submit" type="button" class="sform_g" onClick="window.open('fupload.php?useForm=form1&amp;prevImg=showImg&amp;upUrl=../webimages/index&amp;ImgS=&amp;ImgW=&amp;ImgH=&amp;reItem=rePic','fileUpload','width=500,height=300')" value="重新上傳">
                  ...
                  <tr bgcolor="#DDDDDD" class="t9">
                    ...
                    <td bgcolor="#FFFFFF" class="text_cap"><input name="b_name" type="text" class="sform" id="b_name" value="<?php echo $row_ad['b_name']; ?>" size="40" maxlength="14"></td>
                    </tr>
                  <tr bgcolor="#DDDDDD" class="t9">
                    <td align="right" background="images/transp.gif" bgcolor="#999999" class="contnet_w">副標題:</td>
                    <td bgcolor="#FFFFFF"><input name="b_subname" type="text" class="sform" id="b_subname" value="<?php echo $row_ad['b_subname']; ?>" size="80"></td>
                    </tr>
                  <tr bgcolor="#DDDDDD" class="t9">
                    <td align="right" background="images/transp.gif" bgcolor="#999999" class="contnet_w">連結:</td>
                    <td bgcolor="#FFFFFF"><input name="b_url" type="text" class="sform" id="b_url" value="<?php echo $row_ad['b_url']; ?>" size="60">
                      <span class="text_cap">(若無需連結，請輸入半型#字號)</span></td>
                    </tr>
                  <tr bgcolor="#DDDDDD" class="t9">
                    <td align="right" background="images/transp.gif" bgcolor="#999999" class="contnet_w">顯示與否:</td>
                    <td bgcolor="#FFFFFF" class="text_cap"><input <?php if (!(strcmp($row_ad['b_status'],"Y"))) {echo "checked=\"checked\"";} ?> type="radio" name="b_status" id="radio" value="Y">
